...
class tipo_docu
{
    ...
    try {
        ...
        $sql = "INSERT into tipo_doc values(:ide,:descr)";
    ...
    public function leeer1($v1)
    {
        try 
        {
            ...
            $sql = "SELECT * from tipo_doc where id_tipo_doc  =$v1";
            $resultado = $base->prepare($sql);
            $resultado->execute();
    ...
    public function update1($v1,$v2)
    {
        ...
        try {
            ...
            $sql = "UPDATE tipo_doc SET descri_tipo_doc='$v2' where id_tipo_doc  =$v1;";
            $resultado = $base->prepare($sql);
            $resultado->execute();
            $resultado->closeCursor();
    ...
    public function delete1($v1)
        {
            ...
            try {
                ...
                $sql = "DELETE FROM tipo_doc WHERE id_tipo_doc  ='$v1';";
                $resultado = $base->prepare($sql);
                $resultado->execute();
                $resultado->closeCursor();
                echo "<script language='JavaScript'> 
