...
$sql = "SELECT * FROM usuario, tipo_doc, tipo_asociados_socios, estado_usu WHERE usuario.id_estado_usuario = estado_usu.id_estado_usuario AND usuario.id_tipo_usuario = tipo_asociados_socios.id_tipo_usuario and tipo_doc.id_tipo_doc = usuario.id_tipo_doc and usuario.id_usuario=$busca;";
...
while ($cliente = $resultado->fetch(PDO::FETCH_ASSOC)) {
    $imgPath = "../imgs/imagenes/" . $cliente["imagenk"];
